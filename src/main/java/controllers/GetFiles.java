...
public class GetFiles {
        ...
        //native method
        public native String getFiles(String path,String keyword,int skip);
        

        //method to call the native method to get the required files
        public DirectoryModel getAllFiles(String directoryPath, String keyword,String phone,int skip){

            

                //---------getting all files----------------------------------------------------
                String filesList = getFiles(directoryPath,keyword,skip);
                //System.out.println(filesList+" "+filesList.length());
                if((!filesList.equals("null")) && filesList.length()>0){
                    //-------------------adding the files to map-------------------------------------------------------
                            HashMap<String,String> fileInfo = new HashMap<String,String>();
                            String absolutePath = directoryPath+"/"+filesList;
